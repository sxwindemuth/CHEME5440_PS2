...
# setup the inducer array: units of uM
inducer_array = 10 .^(range(-3,stop=6, length=100))
...
gui()
xlabel!("Inducer concentration (uM)")
ylabel!("Steady state mRNA concentration (uM)")
savefig("PS2_plot.png")